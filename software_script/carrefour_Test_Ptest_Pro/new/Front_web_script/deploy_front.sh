...
web_address_list=(10.171.112.3 10.171.112.4 10.171.112.5 10.171.112.6
                    10.171.112.7 10.171.112.8 10.171.112.9 10.171.112.10 10.171.112.11 10.171.112.12
                    10.171.112.13 10.171.112.14)
...
remote_handle(){
    ...
    do
    {
        ...
        ssh  ${web_address_list[${address}]} "/software/script/carrefour_front.py -d ${handle}"
        echo "\033[32mWaitting Deploy.............\033[0m"
        if [ $? -ne 0 ]; then
